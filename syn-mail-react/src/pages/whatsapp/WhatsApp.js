...
const WhatsApp = () => {
   ...
   },
  {
   ...
   .then(function (response) {
    ...
    setData([{name:'waqas',number:'971565546190'},{name:'waqas',number:'971565546190'},]);
    if(response.data.length > 0){
      setLoading(false);
 ...
 const sendMessageSubmitHandler = () => {
  ...
  axios.post(process.env.REACT_APP_API_URL+'registration/send-whatsapp', {
...
console.log(response)
 ...
 .catch(function (error) {
  ...
  return <>
   <ResponsiveDrawer>
      <h1 style={{ fontWeight:"bold",textTransform:"uppercase" }} >Send Whatsapp Messages</h1>
